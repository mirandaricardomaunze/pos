...
useEffect(() => {
  ...
  return (
    <nav className="bg-blue-600 w-full sticky top-0 z-30 shadow-md">
      <div className="container mx-auto flex flex-wrap items-center justify-between p-2 xs:p-3">
         ...
         <div className="flex items-center">
           {loggedUser && (
             <div className="font-bold bg-blue-700 text-white px-2 py-1 xs:px-3 xs:py-1 rounded-full text-xs xs:text-sm sm:text-base truncate max-w-[120px] xs:max-w-[150px] sm:max-w-none">
               <p className="truncate">Olá {loggedUser}</p>
             </div>
           )}
         </div>
         ...
         <div className="flex items-center space-x-1 xs:space-x-2">
           <div className="flex items-center py-1 px-2 xs:py-2 xs:px-3 rounded-full hover:bg-blue-500 transition-colors duration-200">
             <NotificationList />
           </div>
           {/* Navbar links */}
